    ...
    return (
        <>
            <main className="w-3/4 bg-white p-4 flex flex-wrap border border-black justify-between text-center">
                ...
                <div className=" max-h-16 w-28 text-center rounded-md border border-black px-3 py-2 text-sm font-semibold text-black shadow-sm cursor-pointer hover:bg-slate-400">Manage Sellers</div>
                ...
                <div className=" max-h-16 w-28 text-center rounded-md border border-black px-3 py-2 text-sm font-semibold text-black shadow-sm cursor-pointer hover:bg-slate-400">Manage Users</div>
                <div className=" max-h-16 w-28 text-center rounded-md border border-black px-3 py-2 text-sm font-semibold text-black shadow-sm cursor-pointer hover:bg-slate-400">Manage Contents</div>
