...
const MegaMenu = ({Categories}) => {
  return (
 <div className="absolute top-full mt-2 transition-all duration-500 ease-in-out opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:translate-y-2 z-50 min-w-[700px]">
